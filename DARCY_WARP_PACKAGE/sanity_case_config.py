...
SPATIAL_GRID_CASES: dict[str, dict[str, int | bool]] = {
    ...
    "1000x1001": _grid(1000, 1001),
    "2000x1000": _grid(2000, 1000),
    "3000x111": _grid(3000, 111),
    "3000x223": _grid(3000, 223),
    "3000x333": _grid(3000, 333),
    "3000x999": _grid(3000, 999),
...
# Automatic suite membership.  Keep the steady view backward-compatible with
# the historical selected dictionary, including the locally disabled 3000x1999
# case.  Copies prevent callers from mutating the canonical catalog.
