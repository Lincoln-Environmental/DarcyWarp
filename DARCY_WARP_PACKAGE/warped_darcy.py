...
class WarpDarcySolver:
    ...
    def _make_solver_context(self, *, formulation: str, transient: bool) -> SolverContext:
        ...
        return SolverContext(
            ...
            run_pcg=self._solve_pcg_device_loop,
            run_kcycle=self._solve_multigrid_kcycle_backend,
            run_transient=self._solve_transient_2d_unconfined_backend,
        )
    ...
    def _solve_transient_2d_unconfined_backend(
            self,
            *,
